using FGIAFG.Scraper.PlayStation.Database;
using FGIAFG.Scraper.PlayStation.Scraping;
using FluentResults;
using Microsoft.EntityFrameworkCore;
using Microsoft.EntityFrameworkCore.ChangeTracking;
using Quartz;
using DbContext = FGIAFG.Scraper.PlayStation.Database.DbContext;

namespace FGIAFG.Scraper.PlayStation.Jobs;

internal class ScrapeAndStoreJob : IJob
{
    private readonly PlayStationScraper scraper;
    private readonly DbContext dbContext;
    private readonly ILogger<ScrapeAndStoreJob> logger;

    public ScrapeAndStoreJob(PlayStationScraper scraper, DbContext dbContext, ILogger<ScrapeAndStoreJob> logger)
    {
