...
using FGIAFG.Scraper.PlayStation.Jobs;
using FGIAFG.Scraper.PlayStation.PsApi;
...
namespace FGIAFG.Scraper.PlayStation;
...
internal class Program
{
    public static async Task Main(string[] args)
    {
        ...
        builder.Services.AddTransient<PlayStationScraper>();
